...
// Gestion du slider
const currentSlideIndex = (0, vue_1.ref)(0);
const nextSlide = () => {
    var _a;
    const maxIndex = (((_a = props.produit.photos) === null || _a === void 0 ? void 0 : _a.length) || 1) - 1;
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(Object.assign({ class: "relative w-full h-32 overflow-hidden rounded-lg mb-2" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(Object.assign({ class: "flex w-full h-full slider-container" }, { style: ({ transform: `translateX(-${__VLS_ctx.currentSlideIndex * 100}%)` }) }));
for (const [photo, index] of __VLS_getVForSourceType((__VLS_ctx.produit.photos || [__VLS_ctx.produit.photo_url || 'https://via.placeholder.com/150']))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.img)(Object.assign(Object.assign({ key: (index), src: (photo) }, { class: "w-full h-full object-contain flex-shrink-0 mx-auto" }), { alt: (`Image de ${__VLS_ctx.produit.nom} - ${index + 1}`) }));
}
if (__VLS_ctx.produit.photos && __VLS_ctx.produit.photos.length > 1) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(Object.assign({ class: "absolute bottom-1 left-1/2 transform -translate-x-1/2 flex space-x-1" }));
    for (const [photo, index] of __VLS_getVForSourceType((__VLS_ctx.produit.photos))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(Object.assign(Object.assign({ key: (index) }, { class: "w-1.5 h-1.5 rounded-full bg-gray-400" }), { class: ({ 'bg-[var(--espace-or)]': index === __VLS_ctx.currentSlideIndex }) }));
    }
}
...
(__VLS_ctx.produit.raw_views_count || __VLS_ctx.produit.views_count);
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(Object.assign({ class: "flex items-center gap-1" }));
